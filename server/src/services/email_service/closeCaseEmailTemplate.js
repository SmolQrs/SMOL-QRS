export const closeCaseEmailTemplate = (
  receiver,
  client,
  organizations,
  advisor
  ...
  return `
                                      ...
                                      >
                                        <span class="tinyMce-placeholder"
                                          ><span style="color: #006699"
                                            >SMOL QUICK RESPONSE SYSTEM</span
                                          ></span
                                        >
                                      </h1>
                                    </td>
    ...
    receiver.lastName
                                        ...
                                        <p style="margin: 0; margin-bottom: 5px">
                                          Inzake de hulpvraag van ${
                                            advisor.firstName
                                          } ${advisor.lastName} van
                                          ${
                                        ...
                                        <p style="margin: 0">
                                          <span style="color: #008080"
                                            ><strong
                                              ...
                                              ><span style="color: #000000"
                                                >Is een match gemaakt met:</span
                                              ><span style="color: #008080">
                                                ${
                                                  organizations.length > 0
                                                    ? organizations.join()
                                                    : "Helaas geen match gevonden."
                                                }</span
                                              ></strong
                                            ></span
                                          >
